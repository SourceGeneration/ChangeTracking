...
//public partial class ChanageTrackingPartialSourceGenerator : IIncrementalGenerator
//{
...
//        builder.AppendBlock($"partial {typekind} {typeProxy.Name} : global::{RootNamespace}.ICascadingChangeTracking, global::System.ComponentModel.INotifyPropertyChanged", () =>
//        {
...
//            {
//                var field = "__" + property.GetRecommendFieldName();

//                builder.AppendLine($"private {property.Type} {field};");
//                builder.AppendLine();

//                builder.AppendLine($"private {property.Type} Get{property.PropertyName}() => this.{field};");
//                builder.AppendLine();

//                builder.AppendBlock($"private void Set{property.PropertyName}({property.Type} value)", () =>
//                {
//                    builder.AppendBlock($"if (!global::System.Collections.Generic.EqualityComparer<{property.Type}>.Default.Equals(this.{field}, value))", () =>
//                    {
//                        if (property.Kind == TypeProxyKind.Value)
//                        {
//                            builder.AppendLine($"this.{field} = value;");
//                        }
//                        else
//                        {
//                            builder.AppendBlock($"if (this.{field} is not null)", () =>
//                            {
//                                if (property.NotifyPropertyChanged)
//                                {
//                                    builder.AppendBlock($"if (this.{field} is global::System.ComponentModel.INotifyPropertyChanged __propertyChanged__)", () =>
//                                    {
...
//                                {
//                                    builder.AppendBlock($"if (this.{field} is global::System.Collections.Specialized.INotifyCollectionChanged __collectionChanged__)", () =>
//                                    {
...
//                            {
//                                builder.AppendLine($"this.{field} = null;");
//                            });
//                            builder.AppendBlock("else", () =>
//                            {
//                                if (property.Kind == TypeProxyKind.Collection)
//                                {
//                                    builder.AppendLine($"this.{field} = new global::{RootNamespace}.ChangeTrackingList<{property.ElementType}>(value);");
//                                }
//                                else if (property.Kind == TypeProxyKind.Dictionary)
//                                {
//                                    builder.AppendLine($"this.{field} = new global::{RootNamespace}.ChangeTrackingDictionary<{property.KeyType}, {property.ElementType}>(value);");
//                                }
//                                else
//                                {
//                                    builder.AppendLine($"this.{field} = global::{RootNamespace}.ChangeTrackingProxyFactory.Create(value);");
//                                }

//                                if (property.NotifyPropertyChanged)
//                                {
//                                    builder.AppendLine($"((global::System.ComponentModel.INotifyPropertyChanged)this.{field}).PropertyChanged += OnPropertyChanged;");
//                                }
//                                if (property.NotifyCollectionChanged)
//                                {
//                                    builder.AppendLine($"((global::System.Collections.Specialized.INotifyCollectionChanged)this.{field}).CollectionChanged += OnCollectionChanged;");
//                                }
//                            });
//                            builder.AppendLine();
//                        }
...
//        public string GetRecommendFieldName()
//        {
